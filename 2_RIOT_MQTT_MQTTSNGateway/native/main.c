...
void get_payload(char* payload, char* deviceId){
    ...
    sprintf(payload,"{\"deviceId\": \"%s\", \"humidity\": \"%d\", \"temperature\": \"%d\", \"windDirection\": \"%d\", \"windIntensity\": \"%d\", \"rainHeigth\": \"%d\", \"datetime\": \"%d-%02d-%02d %02d:%02d:%02d\"}", deviceId, temp, hum, win_dir, win_int, rain, tm.tm_year + 1900, tm.tm_mon + 1, tm.tm_mday, tm.tm_hour, tm.tm_min, tm.tm_sec);
